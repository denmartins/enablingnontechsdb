...
class GeneticProgrammingQBE(object):
    ...
    def configure_genetic_programming(self, dataframe):    
        ...
        toolbox.register('evaluate', self.fitness_function.calculate_genetic_fitness)
        # Selection strategy        
        ...
        toolbox.decorate('mate', gp.staticLimit(operator.attrgetter('height'), max_value=50))
    ...
    def search_best_predicate(self, population_size, crossover_rate, mutation_rate, num_generations, max_gen_without_gain, verbose=True):
        ...
        # Get best solution
        best_solution = hall_of_fame['individual']
        return util.genetic_2_predicate(best_solution)