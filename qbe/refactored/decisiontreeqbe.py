...
class DecisionTreeQBE(BaseLearningAlgorithm):    
    def find_selection_predicate(self, positive_indices, negative_indices, verbose):
        self.configure(self.dataset.preprocessed_data, positive_indices)
    ...
    def configure(self, dataframe, positive_indices):
        ...
        all_data['class'] = [int(x in positive_indices) for x in total_indexes]
